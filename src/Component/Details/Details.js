...
const url = "https://jomato-dataset-live.herokuapp.com/restaurantdetails";
const menuUrl = "https://jomato-dataset-live.herokuapp.com/menu";
                         ...
                         <div class="container">
                              <div class="row">
                                   <div class="col-xxl-5 col-xl-5 col-lg-12 col-md-12 col-sm-12 col-12">
                                        <div>
                                             <img src={this.state.details.restaurant_thumbnail} alt="Food" id="picture" class="img-responsive"/>
                                        </div>
                                   </div>
                                   <div class="col-xxl-7 col-xl-7 col-lg-12 col-md-12 col-sm-12 col-12">
                                        ...
                                        <div>
                                             ...
                                             <button class="btn btn-lg" id="button3" type="button" onClick={this.proceed}>
                                                  Checkout
                                             </button>
                                        </div>
                                   </div>
